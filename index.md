...
- template: content-feature
  ...
  aftercontent: <ol start="2"><li>OBS, Xsplit 등등 사용하시는 방송프로그램에서 복사한 주소를 넣어 브라우저 위젯을 만들어 주세요!<br/>*추천 사이즈 - 너비 1700 높이 600</li><li>위젯을 원하는 위치와 사이즈로 조절해주세요!</li><li>완성! 😆</li></ol>
  urltext:
    enabled: true
